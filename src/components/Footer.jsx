...
import FOOTER_LINKS from "../assets/data/footer_links";
import FOOTER_CONTACT_INFO from "../assets/data/footer_contacts";
              ...
              <FooterColumn>
                <ul className="flex gap-4">
                  {SOCIALS.links.map((link) => (
                    <Link to={"/"} key={link}>
                      <img src={link} alt="socailIcon" width={22} height={22} />
                    </Link>
                  ))}
                </ul>
              </FooterColumn>
